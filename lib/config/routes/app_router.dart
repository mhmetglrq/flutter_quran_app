...
import 'package:flutter_quran_app/features/listening/views/surah_listening_page.dart';
...
class AppRouter {
  static Route onGenerateRoutes(RouteSettings settings) {
    switch (settings.name) {
      ...
      case AppRouteNames.surahListening:
        return _materialRoute(const SurahListeningPage());
      case AppRouteNames.listening:
        final args = settings.arguments as Map<String, dynamic>;
        final surahIndex = args['surahIndex'] as int;
        return _materialDialogRoute(Listening(
